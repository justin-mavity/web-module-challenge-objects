...
let item1 = createMenuItem("Pizza", 12, "Itilian");
let item2 = createMenuItem("Pie", 3, "Sweet");
let item3 = createMenuItem("Coke", 2, "Coca Cola");
...
burger.discount = function (str) {
  ...
  if (str === "teacher" || str == "student") {
    ...
    discountPrice = burger.price - (burger.price * .1);
  }
